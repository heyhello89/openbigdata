...
# Split total_charges into quartiles, create binary indicator variables for each of the quartiles, and add them to the churn DataFrame
qcut_names = ['1st_quartile','2nd_quartile','3th_quartile','4th_quartile']
...
# print(logit_marginal_effects.summarty()

print("\ninvlogit(-7.2205 + 0.0012*mean(account_length) + 0.4443*meana(custserv_calls) + 0.0729*mean(total_carges))")
