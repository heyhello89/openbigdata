...
for workbook in all_workbooks:
    ...
    worksheet_data_frames = pd.concat(worksheet_data_frames, axis=0, ignore_index=True)
...
all_data_concatenated.to_excel(writer, sheet_name='sum_and_average', index=False)
writer.save()