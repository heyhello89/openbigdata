...
# plt.suptitle("Joint Plot of Two Variabels with Bivariate and Univariate Graphs")
# plt.show()
...
# plt.title("Logistic Regresession of Big Tip vs. Total Bill")
# plt.show()
...
# Contral shape and size of plot
